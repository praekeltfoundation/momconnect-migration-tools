...
--
-- Name: identities_detailkey; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE identities_detailkey (
    key_name character varying(200) NOT NULL,
    created_at timestamp with time zone NOT NULL
);


ALTER TABLE identities_detailkey OWNER TO postgres;

--
-- Name: identities_identity; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE identities_identity (
    id uuid NOT NULL,
    ...
    communicate_through_id uuid,
    operator_id uuid
);


ALTER TABLE identities_identity OWNER TO postgres;

--
-- Name: identities_optin; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE identities_optin (
    id uuid NOT NULL,
    address_type character varying(50) NOT NULL,
    address character varying(255) NOT NULL,
    request_source character varying(100) NOT NULL,
    requestor_source_id character varying(500),
    created_at timestamp with time zone NOT NULL,
    created_by_id integer,
    identity_id uuid
);
...
ALTER TABLE identities_optin OWNER TO postgres;

--
-- Name: identities_optout; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE identities_optout (
    id uuid NOT NULL,
    optout_type character varying(20) NOT NULL,
    address_type character varying(50) NOT NULL,
    address character varying(255) NOT NULL,
    request_source character varying(100) NOT NULL,
    requestor_source_id character varying(500),
...
ALTER TABLE identities_optout OWNER TO postgres;
...
--
-- Name: identities_detailkey_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_detailkey
    ADD CONSTRAINT identities_detailkey_pkey PRIMARY KEY (key_name);


--
-- Name: identities_identity_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_identity
    ADD CONSTRAINT identities_identity_pkey PRIMARY KEY (id);


--
-- Name: identities_optin_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_optin
    ADD CONSTRAINT identities_optin_pkey PRIMARY KEY (id);


--
-- Name: identities_optout_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_optout
    ADD CONSTRAINT identities_optout_pkey PRIMARY KEY (id);
...
--
-- Name: identities_detailkey_key_name_14e21615_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_detailkey_key_name_14e21615_like ON identities_detailkey USING btree (key_name varchar_pattern_ops);


--
-- Name: identities_identity_48df8100; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_identity_48df8100 ON identities_identity USING btree (communicate_through_id);


--
-- Name: identities_identity_4d14a16b; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_identity_4d14a16b ON identities_identity USING btree (operator_id);


--
-- Name: identities_identity_9ccf0ba6; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_identity_9ccf0ba6 ON identities_identity USING btree (updated_by_id);


--
-- Name: identities_identity_e93cb7eb; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_identity_e93cb7eb ON identities_identity USING btree (created_by_id);


--
-- Name: identities_optin_09913eab; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_optin_09913eab ON identities_optin USING btree (identity_id);


--
-- Name: identities_optin_e93cb7eb; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_optin_e93cb7eb ON identities_optin USING btree (created_by_id);


--
-- Name: identities_optout_09913eab; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_optout_09913eab ON identities_optout USING btree (identity_id);


--
-- Name: identities_optout_e93cb7eb; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX identities_optout_e93cb7eb ON identities_optout USING btree (created_by_id);
...
--
-- Name: ident_communicate_through_id_04e7d5e2_fk_identities_identity_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_identity
    ADD CONSTRAINT ident_communicate_through_id_04e7d5e2_fk_identities_identity_id FOREIGN KEY (communicate_through_id) REFERENCES identities_identity(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: identities_ident_operator_id_e199ae36_fk_identities_identity_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_identity
    ADD CONSTRAINT identities_ident_operator_id_e199ae36_fk_identities_identity_id FOREIGN KEY (operator_id) REFERENCES identities_identity(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: identities_identity_created_by_id_60646680_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_identity
    ADD CONSTRAINT identities_identity_created_by_id_60646680_fk_auth_user_id FOREIGN KEY (created_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: identities_identity_updated_by_id_e4cf9f4f_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_identity
    ADD CONSTRAINT identities_identity_updated_by_id_e4cf9f4f_fk_auth_user_id FOREIGN KEY (updated_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: identities_optin_created_by_id_82b9e33e_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_optin
    ADD CONSTRAINT identities_optin_created_by_id_82b9e33e_fk_auth_user_id FOREIGN KEY (created_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: identities_optin_identity_id_3a694f57_fk_identities_identity_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_optin
    ADD CONSTRAINT identities_optin_identity_id_3a694f57_fk_identities_identity_id FOREIGN KEY (identity_id) REFERENCES identities_identity(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: identities_optou_identity_id_39bcdf96_fk_identities_identity_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_optout
    ADD CONSTRAINT identities_optou_identity_id_39bcdf96_fk_identities_identity_id FOREIGN KEY (identity_id) REFERENCES identities_identity(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: identities_optout_created_by_id_e14d5446_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY identities_optout
    ADD CONSTRAINT identities_optout_created_by_id_e14d5446_fk_auth_user_id FOREIGN KEY (created_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
