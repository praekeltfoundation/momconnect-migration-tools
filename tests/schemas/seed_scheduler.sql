...
--
-- Name: scheduler_schedule; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE scheduler_schedule (
    ...
    cron_definition character varying(500),
    interval_definition character varying(100),
    ...
    celery_cron_definition_id integer,
    celery_interval_definition_id integer,
    created_by_id integer,
    updated_by_id integer
);


ALTER TABLE scheduler_schedule OWNER TO postgres;
...
--
-- Name: scheduler_schedule_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY scheduler_schedule
    ADD CONSTRAINT scheduler_schedule_pkey PRIMARY KEY (id);
...
--
-- Name: scheduler_schedule_9be62dd3; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX scheduler_schedule_9be62dd3 ON scheduler_schedule USING btree (celery_interval_definition_id);


--
-- Name: scheduler_schedule_9ccf0ba6; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX scheduler_schedule_9ccf0ba6 ON scheduler_schedule USING btree (updated_by_id);


--
-- Name: scheduler_schedule_e93cb7eb; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX scheduler_schedule_e93cb7eb ON scheduler_schedule USING btree (created_by_id);


--
-- Name: scheduler_schedule_f9e0a141; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX scheduler_schedule_f9e0a141 ON scheduler_schedule USING btree (celery_cron_definition_id);


--
-- Name: D3215aabb4bc336f96ec9b1374dae728; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY scheduler_schedule
    ADD CONSTRAINT "D3215aabb4bc336f96ec9b1374dae728" FOREIGN KEY (celery_interval_definition_id) REFERENCES djcelery_intervalschedule(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: cf78037ae5e484c8ab23cd5ab30eea2c; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY scheduler_schedule
    ADD CONSTRAINT cf78037ae5e484c8ab23cd5ab30eea2c FOREIGN KEY (celery_cron_definition_id) REFERENCES djcelery_crontabschedule(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: scheduler_schedule_created_by_id_c2a447e6_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY scheduler_schedule
    ADD CONSTRAINT scheduler_schedule_created_by_id_c2a447e6_fk_auth_user_id FOREIGN KEY (created_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: scheduler_schedule_updated_by_id_46e29a19_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY scheduler_schedule
    ADD CONSTRAINT scheduler_schedule_updated_by_id_46e29a19_fk_auth_user_id FOREIGN KEY (updated_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
